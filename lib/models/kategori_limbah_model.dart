...
KategoriLimbah kategoriLimbahFromJson(String str) =>
    KategoriLimbah.fromJson(json.decode(str));
...
class KategoriLimbah {
  ...
  factory KategoriLimbah.fromJson(Map<String, dynamic> json) => KategoriLimbah(
        data: List<KategoriLimbahData>.from(
            json["data"].map((x) => KategoriLimbahData.fromJson(x))),
...
class KategoriLimbahData {
  ...
  factory KategoriLimbahData.fromJson(Map<String, dynamic> json) =>
      KategoriLimbahData(
        id: json["id"],
        name: json["name"],
      );

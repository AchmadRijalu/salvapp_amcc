...
class Provinsi {
  ...
  factory Provinsi.fromJson(Map<String, dynamic> json) => Provinsi(
        ...
        provinsiValue: List<ProvinsiValue>.from(
            json["value"].map((x) => ProvinsiValue.fromJson(x))),
      );
...
class ProvinsiValue {
  ...
  factory ProvinsiValue.fromRawJson(String str) =>
      ProvinsiValue.fromJson(json.decode(str));
